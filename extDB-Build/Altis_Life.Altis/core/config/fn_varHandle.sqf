...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
			...
			case "burgers": {"life_inv_burgers"}; //Burgers
			...
			case "zipties": {"life_inv_zipties"}; //zipties
			...
			case "purpledrank": {"line_inv_purpledrank"};
		};
	};
	...
	case 1:
	{
		switch (_var) do
		{
			...
			case "life_inv_zipties": {"zipties"}; //zipties
			...
			case "life_inv_purpledrank": {"purpledrank"};
		};
	};
};
