...
switch (_shop) do
{
	case "market": {["Altis Market",["water","rabbit","apple","redgull","tbacon","zipties","lockpick","pickaxe","fuelF","peach","storagesmall","storagebig"]]};
	case "burgerjoint": {["Dat Burger Joint",["burgers","purpledrank"]]};
