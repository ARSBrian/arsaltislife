...
*/
	...
	player createDiaryRecord["changelog",
		[
			"[ARS] Altis Life Change Log",
				"
					____________________________________________________________________________<br/>
					Update 0.0.0.7 - 11/27/2014<br/><br/>
					
					Fixes:<br/>
					1. 'y' menu inventory properly shows virtual inventory now.<br/>
					2. Virtual items now save through server restarts.<br/><br/>
					
					Changes:<br/>
					1. Start money for all (cops, civs, and medics) were changed from $7,000 to $20,000 to give new players a better start.<br/><br/>
					
					____________________________________________________________________________<br/>
					Update 0.0.0.6 - 11/26/2014<br/><br/>
					
					Scripts Added:<br/>
					1. New player menu, more to come!<br/>
					2. Logo's added to the slot machines in the casinos.<br/>
					3. You are now able to rob ATM's. (NOT PROPERLY WORKING)<br/><br/>
					
					Fixes:<br/>
					1. ATM added on the first floor of the casino in Kavala.<br/><br/>
					
					____________________________________________________________________________<br/>
					Update 0.0.0.5 - 11/25/2014<br/><br/>
					
					Scripts Added:<br/>
					1. Persistent wanted list added, players crimes will now be saved through restart.<br/>
					2. Casino has been added, still needs some vendors.<br/><br/>
					
					____________________________________________________________________________<br/>
					Update 0.0.0.4 - 11/24/2014<br/><br/>
					
					Scripts Added:<br/>
					1. Dynamic Market has been added, a few items still need to be implimented.<br/><br/>
					
					Fixes:<br/>
					1. Spike strips are now properly working and you will not be kicked off the game when you use them.<br/>
					2. Pull out of the vehicle command for cops has been fixed.<br/><br/>
					
					____________________________________________________________________________<br/>
					Update 0.0.0.3 - 11/23/2014<br/><br/>
					
					Fixes:<br/>
					1. Stores are now working properly.<br/>
					2. Fixed cop slots / medic slots.<br/>
					3. Fixed toolkit, it now has unlimited uses instead of just 1.<br/>
					4. Respawn time went down from 2:00 to 0:30.<br/><br/>
					
					____________________________________________________________________________<br/>
					Update 0.0.0.2 - 11/22/2014<br/><br/>
					
					Scripts Added:<br/>
					1. Extended Admin Menu has been added.<br/><br/>
					
					Fixes:<br/>
					1. ATM's are now marked on the map.<br/>
					2. Police markers added in Kavala.<br/>
					
					____________________________________________________________________________<br/>
					Update 0.0.0.1 - 11/21/2014<br/><br/>
					
					Scripts Added:<br/>
					1. Added Surrender Script.<br/>
					2. Remove weapon script has been added.<br/>
					3. Civilian zipties have been added.<br/><br/>
					
					Fixes:<br/>
					1. ATM added at the highway patrol outpost.<br/>
					2. Cops loadout changed.<br/>
				"
		]
	];
	...
	player createDiaryRecord ["serverrules",
		[
			"Exploits", 
				...
				6. Getting in or switching to the pilot slot of a helicopter while restrained will not be tolerated.<br/><br/>
				"
		]
	];
