...
*/
private["_ui","_food","_water","_health","_bank","_cash"];
...
_bank = _ui displayCtrl 23650;
_cash = _ui displayCtrl 23655;
...
//Update bank
_bank ctrlSetPosition [safeZoneX+safeZoneW-0.090,safeZoneY+safeZoneH-0.410];
_bank ctrlSetText format["%1", life_atmcash];
_bank ctrlCommit 0;
//Update Cash
_cash ctrlSetPosition [safeZoneX+safeZoneW-0.090,safeZoneY+safeZoneH-0.370];
_cash ctrlSetText format["%1", life_cash];
_cash ctrlCommit 0;